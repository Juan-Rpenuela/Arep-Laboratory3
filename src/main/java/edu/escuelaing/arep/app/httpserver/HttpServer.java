...
public class HttpServer {
    ...
    public static void startServer(String[] args) throws IOException, URISyntaxException {
        ...
        while (running) {
            ...
            if (requestPath.startsWith("/app") && !hasFileExtension(requestPath)) {
                invokeService(requestURI, out);
            } else {
                handleStaticFiles(requestURI, out);
            }
    ...
    private static void handleStaticFiles(URI requestURI, OutputStream out) throws IOException {
